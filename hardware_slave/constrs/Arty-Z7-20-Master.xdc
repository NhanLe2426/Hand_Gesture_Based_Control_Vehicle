...
## Switches
set_property -dict { PACKAGE_PIN M20    IOSTANDARD LVCMOS33 } [get_ports { reset_btn }]; #IO_L7N_T1_AD2N_35 Sch=SW0
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { nrf_mosi }]; #IO_L17P_T2_34 Sch=JA1_P (Pin 1)
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { nrf_sck }]; #IO_L17N_T2_34 Sch=JA1_N (Pin 2)
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { nrf_miso }]; #IO_L7P_T1_34 Sch=JA2_P (Pin 3)
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { nrf_ce }]; #IO_L7N_T1_34 Sch=JA2_N (Pin 4)
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { nrf_csn }]; #IO_L12P_T1_MRCC_34 Sch=JA3_P (Pin 7)
...
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { motor_pwm_a }]; #IO_L8N_T1_34 Sch=JB1_N (Pin 2)
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { motor_in1 }]; #IO_L1P_T0_34 Sch=JB2_P (Pin 3)
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { motor_in2 }]; #IO_L1N_T0_34 Sch=JB2_N (Pin 4)
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { motor_pwm_b }]; #IO_L18P_T2_34 Sch=JB3_P (Pin 7)
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { motor_in3 }]; #IO_L18N_T2_34 Sch=JB3_N (Pin 8)
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { motor_in4 }]; #IO_L4P_T0_34 Sch=JB4_P (Pin 9)
